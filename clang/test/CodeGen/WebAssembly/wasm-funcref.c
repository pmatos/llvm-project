...
// CHECK-NEXT:    [[FUNCREF_CONVERT:%.*]] = alloca target("wasm.funcref"), align 4
// CHECK-NEXT:    store ptr [[FNPTR:%.*]], ptr [[FNPTR_ADDR]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[FNPTR_ADDR]], align 4
// CHECK-NEXT:    store ptr [[TMP0]], ptr [[FUNCREF_CONVERT]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load target("wasm.funcref"), ptr [[FUNCREF_CONVERT]], align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = call ptr @llvm.wasm.funcref.to.ptr(target("wasm.funcref") [[TMP0]])
