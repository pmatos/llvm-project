...
void test_table_size(__externref_t ref, void *ptr, int arr[]) {
  ...
  void *a = __builtin_wasm_table_size(table);         // expected-warning {{incompatible integer to pointer conversion initializing 'void *' with an expression of type 'int'}}
...
void test_table_grow(__externref_t ref, int size) {
  ...
  void *a = __builtin_wasm_table_grow(table, ref, size); // expected-warning {{incompatible integer to pointer conversion initializing 'void *' with an expression of type 'int'}}
