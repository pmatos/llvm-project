...
entry:
  ...
  ; CHECK:      %alloc.externref.var = alloca target("wasm.externref"), align 4, addrspace(1)
  ...
  ; CHECK-NEXT: %alloc.funcref.var = alloca target("wasm.funcref"), align 4, addrspace(1)
...
entry:
  ...
  %eref.loaded = load %externref, ptr %alloc.externref, align 1
  call void @take_externref(%externref %eref.loaded)
  ; ATTR:      %alloc.externref.var = alloca target("wasm.externref"), align 4, addrspace(1)
  ...
  %fref.loaded = load %funcref, ptr %alloc.funcref, align 1
  call void @take_funcref(%funcref %fref.loaded)
  ; ATTR-NEXT: %alloc.funcref.var = alloca target("wasm.funcref"), align 4, addrspace(1)
