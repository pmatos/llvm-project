...
; TODO: FastISel does not support funcref calls through the funcref.to.ptr
; intrinsic pattern used with TargetExtType. Add fast-isel=1 test when
; FastISel is updated to handle this pattern.
...
; CHECK-NEXT:    # fallthrough-return
  %ptr = call ptr @llvm.wasm.funcref.to.ptr(%funcref %ref)
  %ret = call float %ptr(double 1.0, i32 2)
  ret float %ret
}
