...
TEST(DataLayoutUpgradeTest, ValidDataLayoutUpgrade) {
  ...
  // Check that WebAssembly targets add -i128:128 and strip stale p10/p20
  // address space entries (reference types now use TargetExtType).
  EXPECT_EQ(
      UpgradeDataLayoutString(
          "e-m:e-p:32:32-p10:8:8-p20:8:8-i64:64-n32:64-S128-ni:1:10:20",
          "wasm32"),
      "e-m:e-p:32:32-i64:64-i128:128-n32:64-S128-ni:1");
  EXPECT_EQ(
      UpgradeDataLayoutString(
          "e-m:e-p:64:64-p10:8:8-p20:8:8-i64:64-n32:64-S128-ni:1:10:20",
          "wasm64"),
      "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128-ni:1");
  // Check that already-upgraded layouts are unchanged.
  EXPECT_EQ(UpgradeDataLayoutString(
                "e-m:e-p:32:32-i64:64-i128:128-n32:64-S128-ni:1", "wasm32"),
            "e-m:e-p:32:32-i64:64-i128:128-n32:64-S128-ni:1");
